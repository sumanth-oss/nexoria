...
function History() {
  ...
  return (
    <div className="mt-5 p-5 border border-[#e9d5ff] rounded-xl bg-white">
      <h2 className="font-bold text-lg text-[#23003c]">Previous Actions</h2>
      <p className="text-gray-600 mb-4">Here is your previous history</p>

      {loading ? (
        <div className="flex flex-col items-center justify-center py-12">
          <Loader2 className="w-8 h-8 text-[#39194f] animate-spin mb-3" />
              ...
              {userHistory.map((history: HistoryItem, index: number) => {
                ...
                return (
                  <div
                    ...
                    className="p-4 border border-gray-200 rounded-lg hover:shadow-md hover:border-[#e9d5ff] transition-all duration-200"
                  >
                      ...
                      <div className="flex items-start space-x-3 flex-1">
                        ...
                        <div className="flex-shrink-0">
                          {IconComponent ? (
                            <div className="w-10 h-10 bg-[#e9d5ff] rounded-lg flex items-center justify-center">
                              <IconComponent className="w-5 h-5 text-[#39194f]" />
                            </div>
                          ) : (
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center space-x-2 mb-2">
                            <h3 className="font-semibold text-[#23003c] truncate">
                      ...
                      {history?.recordId && agent?.path && (
                        <div className="flex-shrink-0 ml-4">
                          <Link
                            ...
                            className="flex items-center space-x-1 px-3 py-2 bg-[#39194f] hover:bg-[#23003c] text-white text-sm rounded-lg transition-colors duration-200"
                          >
                            <span>View</span>
                            <svg
                              className="w-3 h-3"
